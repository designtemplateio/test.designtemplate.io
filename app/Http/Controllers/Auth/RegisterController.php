    ...
    */
	...
	public function register(Request $request)
    {
		...
		if($additional_settings->site_google_recaptcha == 1)
		{
		 ...
		 $messsages = array(
		  //   'username' => ['Please Enter your Username Correctly'],
		...
		if ($validator->fails()) 
		{
		 ...
		 if($rules['email'])
		 {
		 return back()->with('error',"You already registered with $email Email Id. Login Now !");
		 }
        ...
        return back()->with('success','We sent you an activation code. Check your email inbox or spam and click on the link to verify.');	
        }
		else
		{
		 return back()->with('success','Your account has been created. You can now login.');
		}
