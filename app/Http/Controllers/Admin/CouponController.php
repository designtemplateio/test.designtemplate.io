  ...
  public function edit_coupon($coupon_id)
	{
	   ...
	   $getvendor['view'] = Members::getvendorDataCoupon();
	   return view('admin.edit-coupon', [ 'edit' => $edit, 'getvendor' => $getvendor]);
	}
	
	 public function users_coupon($coupon_code)
	{
         $couponcode = base64_decode($coupon_code);
	     $couponData['view'] = Coupon::getallCoupondata($coupon_code);
	     $viewuser['value'] = Coupon::viewuserCoupon($couponcode);
         
	   return view('admin.users-coupon', [ 'couponData' => $couponData, 'viewuser' => $viewuser,'couponcode' => $couponcode]);
	}
