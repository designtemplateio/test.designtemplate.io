...
class ProductPageCategoryController extends Controller
{
    ...
    {
	 	$categoryData['product_page_category'] = ProcuctPageCategory::getcategoryData();
		return view('admin.product-page-category',[ 'categoryData' => $categoryData]);
    }
	...
	public function add_category()
	{
	   ...
	   return view('admin.product-page-add-category');
	}
	...
	public function save_category(Request $request)
	{
        ...
        ProcuctPageCategory::insertcategoryData($data);
		return redirect('/admin/product-page-category')->with('success', 'Insert successfully.');
       } 
  ...
  public function delete_category($cat_id){
      ...
      ProcuctPageCategory::deleteCategorydata($cat_id,$data);
  ...
  public function edit_category($cat_id)
	{
	   ...
	   $edit['product_page_category'] = ProcuctPageCategory::editcategoryData($cat_id);
	   return view('admin.product-page-edit-category', [ 'edit' => $edit, 'cat_id' => $cat_id]);
	}
	...
	public function update_category(Request $request)
	{
		...
		$data = array('category_name' => $category_name, 'category_slug' => $category_slug, 'category_status' => $category_status, 'menu_order' => $menu_order);
        ProcuctPageCategory::updatecategoryData($cat_id, $data);
        return redirect('/admin/product-page-category')->with('success', 'Update successfully.');	
	...
	public function subcategory()
    {
		...
		$subcategoryData['product_page_subcategory'] = ProcuctPageCategory::getsubcategoryData();
		return view('admin.product-page-sub-category',[ 'subcategoryData' => $subcategoryData]);
    }
	
	
	public function add_subcategory()
	{
	   $categoryData['product_page_category'] = ProcuctPageCategory::allcategoryData();
	   return view('admin.product-page-add-subcategory',[ 'categoryData' => $categoryData]);
	}
	...
	public function save_subcategory(Request $request)
	{
        ...
        ProcuctPageCategory::insertsubcategoryData($data);
        return redirect('/admin/product-page-sub-category')->with('success', 'Insert successfully.');   
	...
	public function delete_subcategory($subcat_id){
      ...
      ProcuctPageCategory::deleteSubcategorydata($subcat_id,$data);
  ...
  public function edit_subcategory($subcat_id)
	{
	   $categoryData['product_page_category'] = ProcuctPageCategory::allcategoryData();
	   $edit['product_page_subcategory'] = ProcuctPageCategory::editsubcategoryData($subcat_id);
	   return view('admin.product-page-edit-subcategory', [ 'edit' => $edit, 'subcat_id' => $subcat_id, 'categoryData' => $categoryData]);
	}
	...
	public function update_subcategory(Request $request)
	{
        ...
        ProcuctPageCategory::updatesubcategoryData($subcat_id, $data);
        return redirect('/admin/product-page-sub-category')->with('success', 'Update successfully.');    
