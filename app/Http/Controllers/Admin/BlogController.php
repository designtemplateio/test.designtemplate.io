  ...
  public function edit_blog_category($blog_cat_id)
	...
	public function save_post(Request $request)
	{
		 ...
		 $request->validate([
							...
							'post_desc' => 'required',
							'post_image' => 'required|mimes:jpeg,jpg,png,webp,zip,mp3,mp4,webm|max:'.$image_size,
		...
		if ($request->hasFile('post_image')) {
			...
			$img->save(base_path('public/storage/post/'.$img_name));
			$post_image = $img_name;
		  }
		  else
		  {
  ...
  public function edit_post($post_id)
	...
	public function update_post(Request $request)
	{
		 ...
		 $request->validate([
							...
							'post_short_desc' => 'required',
							'post_desc' => 'required',
							'post_image' => 'mimes:jpeg,jpg,png,webp,zip,mp3,mp4,webm|max:'.$image_size,
							'post_status' => 'required',
							'blog_cat_id' => 'required',
