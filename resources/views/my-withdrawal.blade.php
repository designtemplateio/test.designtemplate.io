<div class="page-title-overlap pt-4" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(3211,$translate,'') }}</h1>
        </div>
      </div>
    </div>
                                ...
                                @php $no = 1; @endphp
                                           ...
                                           <div class="row form-group" id="ifstripe">
                                            ...
                                            <div class="row form-group" id="ifpayfast">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone">{{ Helper::translation('6218d15ed6569',$translate,'PayFast Email ID') }}</label>
                                            ...
                                            <div class="row form-group" id="ifpaytm">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone">{{ Helper::translation('622f1e7b29f63',$translate,'Paytm Number') }}</label>
                                                        <input type="text" id="paytm_no" name="paytm_no" class="form-control" data-bvalidator="required">
                                                </div>
                                            </div>
                                            <div class="row form-group" id="ifupi">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone">{{ Helper::translation('622f214148f4c',$translate,'UPI ID') }}</label>
                                                        <input type="text" id="upi_id" name="upi_id" class="form-control" data-bvalidator="required">
                                                </div>
                                            </div>
                                            <div class="row form-group" id="ifskrill">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone">{{ Helper::translation('622f1e9c16694',$translate,'Skrill Email ID') }}</label>
                                            ...
                                            <div class="row form-group" id="iflocalbank">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        ...
                                                        {{ Helper::translation(5781,$translate,'') }} : {{ Helper::translation('61e677dfca2dd',$translate,'Test Bank') }}<br/>
                                                        {{ Helper::translation(5784,$translate,'') }} : {{ Helper::translation('61e677e7660b0',$translate,'Test Branch') }}<br/>
