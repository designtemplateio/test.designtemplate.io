          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            ...
            <div class="row">
             <div class="col-sm-12 mb-1">
              ...
              <div class="col-sm-12 mb-1">
              <div class="alert alert-info alert-with-icon font-size-sm mb-4" role="alert">
                <div class="alert-icon-box"><i class="alert-icon dwg-announcement"></i></div><b>{{ Helper::translation(2983,$translate,'') }} :</b> jpeg, jpg, png, webp<br/><b>{{ Helper::translation(2985,$translate,'') }} :</b> zip, mp3, mp4<?php /*?>@if(Auth::user()->user_subscr_space_level == 'limited') <br/><b>Available Storage Space : </b> {{ Auth::user()->user_subscr_space }} {{ Auth::user()->user_subscr_space_type }} @endif | <?php */?>
