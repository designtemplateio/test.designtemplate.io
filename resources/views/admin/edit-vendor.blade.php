                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3119,$translate,'') }}<span class="require">*</span></label>
                                                <select name="exclusive_author" class="form-control" required>
                                                <option value=""></option>
                                                <option value="1" @if($edit['userdata']->exclusive_author == 1) selected @endif>{{ Helper::translation(2970,$translate,'') }}</option>
                                                <option value="0" @if($edit['userdata']->exclusive_author == 0) selected @endif>{{ Helper::translation(2971,$translate,'') }}</option>
                                                </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(5667,$translate,'') }}<span class="require">*</span></label>
                                                <select name="user_subscr_payment_status" class="form-control" required>
                                                <option value=""></option>
                                                <option value="pending" @if($edit['userdata']->user_subscr_payment_status == 'pending') selected @endif>{{ Helper::translation(5676,$translate,'') }}</option>
                                                <option value="completed" @if($edit['userdata']->user_subscr_payment_status == 'completed') selected @endif>{{ Helper::translation(5673,$translate,'') }}</option>
                                                </select>
                                                </div>
                                                @endif 
                                                ...
                                                <input type="hidden" name="become_author" value="{{ $edit['userdata']->become_author }}">
                                                <input type="hidden" name="user_subscr_date" value="{{ $edit['userdata']->user_subscr_date }}">
