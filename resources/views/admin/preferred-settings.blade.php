                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('614d4f7745243',$translate,'Verify Purchase') }} <span class="require">*</span></label>
                                                                                                
                                                <select name="verify_mode" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" @if($additional['setting']->verify_mode == 1) selected @endif>{{ Helper::translation(5013,$translate,'') }}</option>
                                                <option value="0" @if($additional['setting']->verify_mode == 0) selected @endif>{{ Helper::translation(5922,$translate,'') }}</option>
                                                </select>
                                            </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(3143,$translate,'') }} <span class="require">*</span></label>
                                                                                                
                                                <select name="refund_mode" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" @if($additional['setting']->refund_mode == 1) selected @endif>{{ Helper::translation(5013,$translate,'') }}</option>
                                                <option value="0" @if($additional['setting']->refund_mode == 0) selected @endif>{{ Helper::translation(5922,$translate,'') }}</option>
                                                </select>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(6306,$translate,'') }} <span class="require">*</span></label>
                                                                                                
                                                <select name="conversation_mode" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" @if($additional['setting']->conversation_mode == 1) selected @endif>{{ Helper::translation(5013,$translate,'') }}</option>
                                                <option value="0" @if($additional['setting']->conversation_mode == 0) selected @endif>{{ Helper::translation(5922,$translate,'') }}</option>
                                                </select>
                                            </div>
