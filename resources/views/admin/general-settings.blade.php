                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <textarea name="site_keywords" id="site_keywords" rows="6" placeholder="separate keywords with commas" class="form-control noscroll_textarea" required>{{ $setting['setting']->site_keywords }}</textarea>
                                            </div>  
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('61dd2e2588231',$translate,'URL Rewriting') }}?<span class="require">*</span></label><br/>
                                              <select name="site_url_rewrite" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($additional->site_url_rewrite == 1) selected @endif>{{ Helper::translation(5325,$translate,'') }}</option>
                                                        <option value="0" @if($additional->site_url_rewrite == 0) selected @endif>{{ Helper::translation(5328,$translate,'') }}</option>
                                              </select>
                                              <small>({{ Helper::translation('61dd3024981c6',$translate,'if "ON" search engine friendly') }}) </small>
                                            </div>
                                            
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('6208d9b617ccc',$translate,'Invoice (PDF) Multi-language') }}?<span class="require">*</span></label><br/>
                                              <select name="site_invoice" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($additional->site_invoice == 1) selected @endif>{{ Helper::translation(5325,$translate,'') }}</option>
                                                        <option value="0" @if($additional->site_invoice == 0) selected @endif>{{ Helper::translation(5328,$translate,'') }}</option>
                                              </select>
                                              <small>({{ Helper::translation('6208dbf6e5511',$translate,'if "OFF" keep english language') }}) </small>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('61dd0addc4b20',$translate,'site email address display on contact page') }}?<span class="require">*</span></label><br/>
                                              <select name="site_email_display" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($additional->site_email_display == 1) selected @endif>{{ Helper::translation(5325,$translate,'') }}</option>
                                                        <option value="0" @if($additional->site_email_display == 0) selected @endif>{{ Helper::translation(5328,$translate,'') }}</option>
                                              </select>
                                            </div>   
                                            
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('61dd0afde3368',$translate,'site phone number display on contact page') }}?<span class="require">*</span></label><br/>
                                              <select name="site_phone_display" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($additional->site_phone_display == 1) selected @endif>{{ Helper::translation(5325,$translate,'') }}</option>
                                                        <option value="0" @if($additional->site_phone_display == 0) selected @endif>{{ Helper::translation(5328,$translate,'') }}</option>
                                              </select>
                                            </div>
                                            
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('61dd0b1c91326',$translate,'site address display on contact page') }}?<span class="require">*</span></label><br/>
                                              <select name="site_address_display" class="form-control" required>
                                                        <option value=""></option>
                                                        <option value="1" @if($additional->site_address_display == 1) selected @endif>{{ Helper::translation(5325,$translate,'') }}</option>
                                                        <option value="0" @if($additional->site_address_display == 0) selected @endif>{{ Helper::translation(5328,$translate,'') }}</option>
                                              </select>
                                            </div>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label for="site_loader_display" class="control-label mb-1">{{ Helper::translation(6249,$translate,'') }}<span class="require">*</span></label><br/>
                                              ...
                                              <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ Helper::translation(6381,$translate,'') }} (Tawk.to)<span class="require">*</span></label>
                                                
                                            <input type="text" name="site_tawk_chat" id="site_tawk_chat" class="form-control noscroll_textarea" value="{{ $additional->site_tawk_chat}}" required /><small><strong>Example:</strong> {{ $additional->site_tawk_chat}}</small>
                                            </div>  
                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                             ...
                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1">{{ Helper::translation('61dd092fc939a',$translate,'Header') }} {{ Helper::translation(5358,$translate,'') }} ({{ Helper::translation(2946,$translate,'') }} 180 x 50)<span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1">{{ Helper::translation('61dd093be05a1',$translate,'Footer Logo') }} ({{ Helper::translation(2946,$translate,'') }} 150 x 43)<span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation(5394,$translate,'') }}?<span class="require">*</span></label><br/>            
                                             ...
                                             <div class="form-group">
                                              ...
                                              <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation('61dd095d9f808',$translate,'Google Recaptcha') }}?<span class="require">*</span></label><br/>
                                            ...
                                            <div class="form-group">
                                                <label for="site_loader_display" class="control-label mb-1">{{ Helper::translation(6252,$translate,'') }}<span class="require">*</span></label><br/>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('631ed7471a39d',$translate,'Disable View Source Code') }}<span class="require">*</span></label>
                                                <select name="disable_view_source" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" @if($additional->disable_view_source == "1") selected @endif>{{ Helper::translation(2970,$translate,'') }}</option>
                                                <option value="0" @if($additional->disable_view_source == "0") selected @endif>{{ Helper::translation(2971,$translate,'') }}</option>
                                                </select>
                                            </div>
                                            <input type="hidden" name="site_free_items_price" value="1">
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ Helper::translation('6368fe45a5766',$translate,'Custom Js Code') }}</label>
                                                <textarea name="site_custom_js" id="site_custom_js" rows="6" class="form-control noscroll_textarea">{{ $additional->site_custom_js }}</textarea></div><small>{{ Helper::translation('6368fe52a946f',$translate,'Example JS Code') }}: <code><br/>$("body").css("background-color","blue");</code></small>
