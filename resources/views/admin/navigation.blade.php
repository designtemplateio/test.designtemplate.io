                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-user"></i><a href="{{ url('/admin/subscriber') }}">Subscriber</a></li>
                            <li><i class="fa fa-user"></i><a href="{{ url('/admin/author') }}">Author</a></li>
                        </ul>
                    </li>
                    @endif                   
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/item-tags') }}">Item Tags</a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/suggestions') }}">Suggestions</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/product-page') }}">Product Pages</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/product-page-category') }}">Category</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/product-page-sub-category') }}">Subcategory</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-money"></i>{{ Helper::translation('61b32a5049abd',$translate,'Deposit') }}</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/deposit') }}">{{ Helper::translation('631f00343d460',$translate,'Price Details') }}</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/deposit-details') }}">{{ Helper::translation('631f01f335a4e',$translate,'Deposit Details') }}</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ url('/admin/email-template') }}"> <i class="menu-icon fa fa-envelope"></i>{{ Helper::translation('614ef338bd8af',$translate,'Email Template') }} </a>
                    </li>
                    @endif
                    @if(in_array('ccache',$avilable))
                    <li>
                        <a href="{{ url('/admin/clear-cache') }}" onClick="return confirm('{{ Helper::translation(6419,$translate,'Are you sure you want to clear cache') }}?');"> <i class="menu-icon fa fa-trash"></i>{{ Helper::translation(6414,$translate,'Clear Cache') }} </a>
                    </li>
                    @endif
                    @if(in_array('upgrade',$avilable))
                    <li>
                        <a href="{{ url('/admin/upgrade') }}"> <i class="menu-icon fa fa-refresh"></i>{{ Helper::translation(6132,$translate,'Upgrade') }} </a>
                    </li>
                    @endif
                    @if(in_array('backups',$avilable))
                    <li>
                        <a href="{{ url('/admin/backup') }}"> <i class="menu-icon fa fa-hdd-o"></i>{{ Helper::translation('6245a88b2aea5',$translate,'Backups') }} </a>
                    </li>
                    @endif
                </ul>
            </div><!-- /.navbar-collapse -->
