                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $refund)
                                        <tr>
                                            ...
                                            @else
                                            <a href="{{ URL::to('/admin/refund') }}/{{ $refund->refund_id }}" class="btn btn-danger btn-sm" onClick="return confirm('{{ Helper::translation(5064,$translate,'') }}?');"><i class="fa fa-trash"></i>&nbsp;{{ Helper::translation(2924,$translate,'') }}</a>@endif
                                            </td>
                                        </tr>
