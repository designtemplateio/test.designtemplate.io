            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Product Page {{ Helper::translation(5049,$translate,'') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.product-page-add-subcategory') }}" method="post" id="setting_form" enctype="multipart/form-data">
