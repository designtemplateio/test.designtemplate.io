                                 ...
                                 <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="0" @if($edit['subscri']->highlight_pack == 0) selected @endif>{{ Helper::translation(2971,$translate,'') }}</option>
                                                <option value="1" @if($edit['subscri']->highlight_pack == 1) selected @endif>{{ Helper::translation(2970,$translate,'') }}</option>
                                                </select>
