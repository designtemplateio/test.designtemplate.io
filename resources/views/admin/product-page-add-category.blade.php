            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Product Page {{ Helper::translation(4986,$translate,'') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.product-page-add-category') }}" method="post" id="setting_form" enctype="multipart/form-data">
