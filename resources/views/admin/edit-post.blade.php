                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <input type="hidden" name="post_date" value="{{ $edit['post']->post_date }}">  
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['post']->post_allow_seo == 1) selected @endif>{{ Helper::translation(2970,$translate,'') }}</option>
                                                <option value="0" @if($edit['post']->post_allow_seo == 0) selected @endif>{{ Helper::translation(2971,$translate,'') }}</option>
                                                </select>
                                             </div>
