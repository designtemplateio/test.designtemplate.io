<div class="page-title-overlap pt-4" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(2930,$translate,'') }}</h1>
        </div>
      </div>
    </div>
          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              ...
              <div class="row mx-n2 pt-2">
                ...
                <div class="col-md-4 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    <h3 class="font-size-sm text-muted">Today's Total Downloaded my Items</h3>
                    <p class="h2 mb-2">{{  $total_download }}</p>
                  </div>
                </div>
                <div class="col-md-4 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    <h3 class="font-size-sm text-muted">Today's Downloaded my Free Items</h3>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#FreeDownload">
                    <p class="h2 mb-2">{{ $total_free_download }}</p>
                    </a>
                  </div>
                </div>
                <div class="col-md-4 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    <h3 class="font-size-sm text-muted">Today's Downloaded my Subscription Items</h3>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#SubscriptionDownload">
                    <p class="h2 mb-2">{{  $total_subscription_download }}</p>
                    </a>
                  </div>
                </div>
              </div>
                            ...
                            <table class="table">
                                ...
                                @foreach($orderData['item'] as $item)
                                    <tr class="prod-item">
                                        ...
                                        <td class="type">{{ $item->payment_type }}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @if($subscription->subscription_items == 1)
