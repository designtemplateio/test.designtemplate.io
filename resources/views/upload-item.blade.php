...
<html lang="en">
<head>
<title>@if(Auth::user()->user_type == 'vendor' || Auth::user()->user_type == 'customer') {{ Helper::translation(2931,$translate,'') }} @else {{ Helper::translation(2860,$translate,'') }} @endif - {{ $allsettings->site_title }}</title>
@include('meta')
@include('style')
</head>
<body>
