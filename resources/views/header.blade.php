      ...
      <!--<div class="navbar-tool"><a class="navbar-tool-icon-box" href="{{ url('/cart') }}"><span class="navbar-tool-label">{{ $cartcount }}</span><i class="navbar-tool-icon dwg-cart"></i></a></div>-->
            ...
            <div class="collapse navbar-collapse mr-0 px-1 order-lg-2 justify-content-left" id="navbarCollapse" style="background:none;">
              ...
              <ul class="navbar-nav ml-0 pl-0">
                ...
                <!--<li class="nav-item dropdown"><a class="nav-link dropdown-toggle headname" style="color:#454545;font-size:14px;" href="javascript:void(0)" target="_parent" onclick="window.open('{{ url('/free-items') }}','_self');" data-toggle="dropdown"><i class="fa fa-gift" aria-hidden="true" style="color:#69b3fe;"></i> Free Templates</a>-->
                <!--  <ul class="dropdown-menu">-->
                <!--    @foreach($categories['menu'] as $menu)-->
                <!--    @if($menu->cat_id==14 || $menu->cat_id==15)-->
                <!--    <li class="nav-item dropdown border-bottom">-->
                <!--    <a @if(count($menu->subcategory) != 0)  class="mobiledev dropdown-item" data-toggle="dropdown" @else class="mobiledev dropdown-item" @endif href="{{ URL::to('/free-items/') }}/{{$menu->category_slug}}">{{ $menu->category_name }}</a>-->
                <!--    <a @if(count($menu->subcategory) != 0)  class="desktopdev dropdown-item"  @else class="desktopdev dropdown-item" @endif href="{{ URL::to('/free-items/') }}/{{$menu->category_slug}}">{{ $menu->category_name }}</a>-->
                <!--    </li>-->
                <!--    @endif-->
                <!--   @endforeach -->
                <!--  </ul>-->
                ...
                <!--    @foreach($categories['menu'] as $menu)-->
                <!--    <li class="nav-item dropdown border-bottom">-->
                <!--    <a @if(count($menu->subcategory) != 0)  class="mobiledev dropdown-item dropdown-toggle" data-toggle="dropdown" @else class="mobiledev dropdown-item" @endif href="{{ URL::to('/product-page/category/') }}/{{$menu->category_slug}}">{{ $menu->category_name }}</a>-->
                <!--    <a @if(count($menu->subcategory) != 0)  class="desktopdev dropdown-item dropdown-toggle"  @else class="desktopdev dropdown-item" @endif href="{{ URL::to('/product-page/category/') }}/{{$menu->category_slug}}">{{ $menu->category_name }}</a>-->
                <!--      @if(count($menu->subcategory) != 0)-->
                <!--      <ul class="dropdown-menu">-->
                <!--        @foreach($menu->subcategory as $sub_category)-->
                <!--        <li><a class="dropdown-item" href="{{ URL::to('/product-page/subcategory/') }}/{{$sub_category->subcategory_slug}}">{{ $sub_category->subcategory_name }}</a></li>-->
                <!--        @endforeach-->
                <!--      </ul>-->
                <!--      @endif-->
                <!--    </li>-->
                ...
                <!--<li class="nav-item dropdown"><a class="nav-link dropdown-toggle headname" style="color:#454545;font-size:14px;" href="javascript:void(0)" target="_parent" data-toggle="dropdown">Product</a>-->
                <!--  <ul class="dropdown-menu">-->
                <!--    @foreach($product_cat['category'] as $menu1)-->
                <!--    <li class="nav-item dropdown border-bottom">-->
                <!--    <a @if(count($product_cat['category']) != 0)  class="mobiledev dropdown-item dropdown-toggle" data-toggle="dropdown" @else class="mobiledev dropdown-item" @endif href="{{ URL::to('/product-page/category/') }}/{{$menu1->category_slug}}">{{ $menu1->subcategory_name }}</a>-->
                <!--    <a @if(count($product_cat['category']) != 0)  class="desktopdev dropdown-item dropdown-toggle"  @else class="desktopdev dropdown-item" @endif href="{{ URL::to('/product-page/category/') }}/{{$menu1->category_slug}}">{{ $menu1->category_name }}</a>-->
                <!--      @if(count($product_cat['category']) != 0)-->
                <!--      <ul class="dropdown-menu">-->
                        
                <!--        <li><a class="dropdown-item" href="{{ URL::to('/product-page/subcategory/') }}/{{$menu1->subcategory_slug}}">{{ $menu1->subcategory_name }}</a></li>-->
