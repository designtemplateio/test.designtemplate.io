...
.btn-custom
{
color:{{ $additional->download_button_text_color }};background-color:{{ $additional->download_button_bg_color }};border-color:{{ $additional->download_button_bg_color }};box-shadow:none;
}
.btn-custom:hover
{
color:{{ $additional->download_button_text_color }};
}
.btn-favorites
{
color:{{ $additional->favorites_button_text_color }};background-color:{{ $additional->favorites_button_bg_color }};border-color:{{ $additional->favorites_button_bg_color }};box-shadow:none;
}
.btn-favorites:hover
{
color:{{ $additional->favorites_button_text_color }};
}
.btn-portfolio
{
color:{{ $additional->portfolio_button_text_color }};background-color:{{ $additional->portfolio_button_bg_color }};border-color:{{ $additional->portfolio_button_bg_color }};box-shadow:none;
}
.btn-portfolio:hover
{
color:{{ $additional->portfolio_button_text_color }};
}
/* extra work */
</style>
