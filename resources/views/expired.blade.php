<section class="bg-position-center-top" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(6105,$translate,'') }}</h1>
        </div>
      </div>
      </div>
    </section>
<div class="container py-5 mt-md-2 mb-2">
      <div class="row">
        <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200" align="center">
          <h4>{{ Helper::translation('61e6743e84157',$translate,'Your subscription has been expired. Please renewal your') }} <a href="{{ URL::to('/pricing') }}">{{ Helper::translation(6105,$translate,'') }}</a></h4><br/>
         </div>
      </div>
    </div>