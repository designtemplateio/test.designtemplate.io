...
<section class="bg-position-center-top" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(3225,$translate,'') }}</h1>
        </div>
      </div>
      </div>
    </section>
        ...
        <div class="col-md-6 mx-auto">
          <div class="card border-0 box-shadow">
            ...
            @if($allsettings->display_social_login == 1)
              <h1 class="h3 mb-1 text-center">{{ Helper::translation(3225,$translate,'') }}</h1>
              <div class="py-3">
              ...
              <form action="{{ route('login') }}" method="POST" id="login_form" class="@if($allsettings->display_social_login == 0) py-3 @endif">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                  <div>
                  <span class="text15">{{ Helper::translation(4875,$translate,'') }}</span> <a href="{{ URL::to('/register') }}" class="nav-link-inline font-size-sm">{{ Helper::translation(3187,$translate,'') }}</a>
