...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - {{ Helper::translation(2860,$translate,'') }}</title>
@include('meta')
@include('style')
</head>
<body>
...
<section class="bg-position-center-top" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(2860,$translate,'') }}</h1>
        </div>
      </div>
      </div>
    </section>
      ...
      <div class="row justify-content-center pt-lg-4 text-center">
        <div class="col-lg-5 col-md-7 col-sm-9">
          ...
          <button type="button" class="btn contactbuttons-first justify-item-center">
                      <a class="navbar-tool p-0 my-n1" href="{{ URL::to('/') }}" style="color:#fff;">Go To Homepage</a>
                    </button>
        </div>
