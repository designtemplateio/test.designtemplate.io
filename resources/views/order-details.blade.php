...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - {{ Helper::translation(3097,$translate,'') }}</title>
@include('meta')
@include('style')
</head>
<body>
...
<div class="page-title-overlap pt-4" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(3097,$translate,'') }}</h1>
        </div>
      </div>
    </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ Helper::translation(3104,$translate,'') }} & {{ Helper::translation(3042,$translate,'') }}</th>
                                                ...
                                                <?php /*?><th>{{ Helper::translation(6306,$translate,'') }}</th><?php */?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        @php $earn = 0; @endphp
                                        ...
                                        <tr>
                                                ...
                                                <td class="detail">
												    ...
												    {{ $order->item_name }}	  
												    @endif
													</a> {{ Helper::translation(3034,$translate,'') }} <a href="{{ URL::to('/user') }}/{{ $order->username }}" class="theme-color">{{ $order->username }}</a>
                                                </td>
