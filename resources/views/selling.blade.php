<section class="bg-position-center-top" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(3018,$translate,'') }}</h1>
        </div>
      </div>
      </div>
    </section>
          ...
          <div class="row border-bottom features mt-3 pt-3">
            <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 right-border border-data">
                  <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box1_icon }}"  alt="{{ $setting['setting']->box1_title }}">
                                    @endif
									</div>
									<div class="info">
                   ...
                   <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 border-data">
                        <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box2_icon }}"  alt="{{ $setting['setting']->box2_title }}">
                                    @endif
									</div>
									<div class="info">
                ...
                <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 right-border">
                      <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box3_icon }}"  alt="{{ $setting['setting']->box3_title }}">
                                    @endif
									</div>
									<div class="info">
                      ...
                      <div class="col-lg-6 col-md-6 mt-3 mb-3 pt-3 pb-3 ">
                          <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box4_icon }}"  alt="{{ $setting['setting']->box4_title }}">
                                    @endif
									</div>
									<div class="info">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-12 mt-3 mb-3 pt-3 pb-3 right-border">
                       <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box5_icon }}"  alt="{{ $setting['setting']->box5_title }}">
                                    @endif
									</div>
									<div class="info">
                            ...
                            <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box6_icon }}"  alt="{{ $setting['setting']->box6_title }}">
                                    @endif
									</div>
									<div class="info">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-12 mt-3 mb-3 pt-3 pb-3">
                             <div class="icon">
                                    ...
                                    <img class="lazy img-fluid icon-img" width="75" height="75" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->box7_icon }}"  alt="{{ $setting['setting']->box7_title }}">
                                    @endif
									</div>
									<div class="info">
