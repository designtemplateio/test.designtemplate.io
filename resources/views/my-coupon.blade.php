<div class="page-title-overlap pt-4" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">{{ Helper::translation(2919,$translate,'') }}</h1>
        </div>
      </div>
    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody id="listShow">
                                    ...
                                    @foreach($couponData['view'] as $coupon)
                                        <tr class="prod-item">
                                            <td>{{ $no }}</td>
                                            <td>{{ $coupon->coupon_code }}  <a href="users-coupon/{{ base64_encode($coupon->coupon_code) }}" class="badge badge-info p-1 m-1">View</a> </td>
