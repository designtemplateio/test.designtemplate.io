<div class="cz-sidebar-static rounded-lg box-shadow-lg px-0 pb-0 mb-5 mb-lg-0">
            <div class="px-4 mb-4">
              <div class="media align-items-center">
                ...
                <div class="media-body pl-3">
				  ...
				  {{ Auth::user()->name }}	  
				  @endif<br>	  
			      @if($addition_settings->subscription_mode == 1) @if(Auth::user()->user_type == 'vendor') @if(Auth::user()->user_document_verified == 1) <span class="badges-success"><i class="dwg-check-circle danger"></i> {{ Helper::translation(5202,$translate,'') }}</span> @endif @endif @endif</h3><span class="text-accent font-size-sm">{{ Auth::user()->email }}</span>
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/user') }}/{{ Auth::user()->username }}"><i class="dwg-home opacity-60 mr-2"></i>Portfolio</a></li>
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/profile-settings') }}"><i class="dwg-settings opacity-60 mr-2"></i>Profile Settings</a></li>
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/affiliates') }}/{{ Auth::user()->username }}"><i class="dwg-money-bag opacity-60 mr-2"></i>Affiliate Program</a></li>
            ...
            @else
              <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/manage-item') }}"><i class="dwg-briefcase opacity-60 mr-2"></i>Become Author</a></li>
            @endif
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/deposit') }}"><i class="dwg-money-bag opacity-60 mr-2"></i>{{ Helper::translation('61b32a5049abd',$translate,'Deposit') }}</a></li>
            @if(Auth::user()->exclusive_author == 1)
            ...
            <!--<li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/coupon') }}"><i class="dwg-gift opacity-60 mr-2"></i>{{ Helper::translation(2919,$translate,'') }}</a></li>-->
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/affiliates') }}/{{ Auth::user()->username }}"><i class="dwg-money-bag opacity-60 mr-2"></i>Affiliate Program</a></li>
            @if(Auth::user()->exclusive_author == 0)
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/manage-item') }}"><i class="dwg-briefcase opacity-60 mr-2"></i>Become Author</a></li>
            @else
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ URL::to('/manage-item') }}"><i class="dwg-briefcase opacity-60 mr-2"></i>{{ Helper::translation(2932,$translate,'') }}</a></li>
            @endif
