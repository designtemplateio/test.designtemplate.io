...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - {{ Helper::translation(3197,$translate,'') }}</title>
@include('meta')
@include('style')
</head>
<body>
      ...
      <div class="bg-light box-shadow-lg rounded-lg overflow-hidden">
        <div class="row">
          ...
          <section class="col-lg-8 pt-lg-4 pb-md-4">
            ...
            <h2 class="h3 pt-2 pb-4 mb-4 text-center text-sm-left border-bottom">@if($followercount <= 1) {{ Helper::translation(3198,$translate,'') }} @else {{ Helper::translation(3197,$translate,'') }} @endif<span class="badge badge-secondary font-size-sm text-body align-middle ml-2">{{ $followercount }}</span></h2>
        <div class="row pt-2">
