...
<script>
    ...
    var myDropzone = new Dropzone(".dropzone",{ 
        ...
        acceptedFiles: ".jpeg,.jpg,.png,.webp,.zip,.mp4,.mp3",
		/*thumbnailWidth: 314, 
        thumbnailHeight: 314,*/
		addRemoveLinks: true,
		...
		removedfile: function(file) 
            {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo e(url("/admin/file-delete")); ?>',
...
</script><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/zone.blade.php ENDPATH**/ ?>