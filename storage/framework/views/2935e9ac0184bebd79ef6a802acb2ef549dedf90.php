   ...
   <div class="container-fluid-sm p-2"> 
        <div class="dropdown d-flex justify-content-between align-item-center">
            ...
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"style="color:#000000;"><?php echo e(Helper::translation(3027,$translate,'')); ?></li>
            </ol>
          </nav>
        </div>
    </div>
    ...
    <div class="container text-center align-items-center justify-content-center">
             <h1 class="heading text-center text-wrap px-2" style="font-size:3rem;">Editor's Choice: Must-Try Design Templates for Stunning Visuals!</h1>
              <p class="sm-heading text-center py-1 px-3">Discover curated gems at designtemplate.io. From captivating After Effects templates for logo animation and text effects to enchanting wedding invitations and dynamic slideshows. Explore motion design, eye-catching illustrations, and seamless Adobe Premiere Pro overlays. Elevate your content with our recommended items.</p>
...
<div class="container text-center align-items-center justify-content-center">
        <p class="sm-heading text-justify py-5 px-3">Explore our handpicked selection of top-tier resources on designtemplate.io, encompassing a diverse range of creative essentials. Elevate your projects with our After Effects templates, embracing captivating motion design, logo animation, and mesmerizing slideshow templates. Craft impactful intros, dynamic Instagram story templates, and immersive illustrations. Make your events truly memorable with elegant wedding invitations. Engage with captivating text animations, and reimagine your branding with logo animation. Our offerings extend to Adobe Premiere Pro, ensuring seamless video editing experiences. From professional Twitch overlays to enchanting slideshow templates, our recommended items cater to every creative need, empowering you to unleash your artistic vision with flair.</p>
</div>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/featured-items.blade.php ENDPATH**/ ?>