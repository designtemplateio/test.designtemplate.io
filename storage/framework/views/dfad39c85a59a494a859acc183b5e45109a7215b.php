        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <input id="search" name="search" type="text" class="move-bars" value="<?php echo e($search); ?>" placeholder="<?php echo e(Helper::translation(2938,$translate,'')); ?>">
                                ...
                                <table id="bootstrap-data-table-export-items" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="50"><?php echo e(Helper::translation(5463,$translate,'')); ?></th>
                                            <th width="100"><?php echo e(Helper::translation(2938,$translate,'')); ?></th>
                                            <th width="100"><?php echo e(Helper::translation(5466,$translate,'')); ?>?</th>
                                            <th><?php echo e(Helper::translation(5472,$translate,'')); ?>?</th>
                                            <th><?php echo e(Helper::translation('62ea38a0b2564',$translate,'Subscription Item')); ?>?</th>
                                    ...
                                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php if($item->item_featured == 'no'): ?> <span class="badge badge-danger"><?php echo e(Helper::translation(2971,$translate,'')); ?></span> <?php else: ?> <span class="badge badge-success"><?php echo e(Helper::translation(2970,$translate,'')); ?></span> <?php endif; ?> <a href="items/<?php echo e($item->item_featured); ?>/<?php echo e($item->item_token); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;"><?php echo e(Helper::translation(5916,$translate,'')); ?></a></td>
                                            ...
                                            <td><?php if($item->subscription_item == 1): ?> <span class="badge badge-success"><?php echo e(Helper::translation(2970,$translate,'')); ?></span> <?php else: ?> <span class="badge badge-danger"><?php echo e(Helper::translation(2971,$translate,'')); ?></span> <?php endif; ?><a href="items/<?php echo e($item->subscription_item); ?>/<?php echo e($item->item_token); ?>/<?php echo e($item->free_download); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;"><?php echo e(Helper::translation(5916,$translate,'')); ?></a></td>
                                            <td><?php if($item->subscription_item == 0): ?> <span class="badge badge-success"><?php echo e(Helper::translation(2970,$translate,'')); ?></span> <?php else: ?> <span class="badge badge-danger"><?php echo e(Helper::translation(2971,$translate,'')); ?></span> <?php endif; ?>  </td>
                                            ...
                                            <?php if($demo_mode == 'on'): ?> 
                                            <a href="demo-mode" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;<?php echo e(Helper::translation('614dc152e18b4',$translate,'Trash')); ?></a>
                                            <a href="demo-mode" class="btn btn-primary btn-sm"><i class="fa fa-download"></i>&nbsp;<?php echo e(Helper::translation(3144,$translate,'')); ?></a>
                                            <?php else: ?>
                                            <a href="items/<?php echo e($item->item_token); ?>" class="btn btn-danger btn-sm" onClick="return confirm('<?php echo e(Helper::translation('614dc5af68305',$translate,'Are you sure you want to remove')); ?>?');"><i class="fa fa-trash"></i>&nbsp;<?php echo e(Helper::translation('614dc152e18b4',$translate,'Trash')); ?></a>
                                            <a href="download/<?php echo e($item->item_token); ?>" class="btn btn-primary btn-sm"><i class="fa fa-download"></i>&nbsp;<?php echo e(Helper::translation(3140,$translate,'')); ?></a>
                                            <?php endif; ?></td>
                                        </tr>
                                        <?php $no++; ?>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/items.blade.php ENDPATH**/ ?>