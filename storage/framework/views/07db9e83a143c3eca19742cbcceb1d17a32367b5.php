...
<html lang="en">
<head>
<title><?php echo e($allsettings->site_title); ?> - <?php echo e(Helper::translation(3200,$translate,'')); ?></title>
...
<div class="container mb-5 pb-3">
      <div class="bg-light box-shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom prod-item" data-aos="fade-up" data-aos-delay="200">
            ...
            <img class="lazy img-rounded" width="112" height="112" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($follower->user_photo); ?>"  alt="<?php echo e($follower->username); ?>">
            <?php else: ?>
            <img class="lazy img-rounded" width="112" height="112" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  alt="<?php echo e($follower->username); ?>">
            <?php endif; ?>
            </a>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/user-following.blade.php ENDPATH**/ ?>