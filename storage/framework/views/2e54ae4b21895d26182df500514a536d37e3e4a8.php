                        ...
                        <div class="card">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                              ...
                              <div class="col-md-12"><div class="card-body"><h4><?php echo e(Helper::translation('61e516b61908b',$translate,'Text Limitation')); ?></h4></div></div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation('61e51a444247c',$translate,'Post Short Description')); ?> (<?php echo e(Helper::translation('61e51a3a36990',$translate,'chars length')); ?>) <span class="require">*</span></label><br/>
                                               <input id="post_short_desc_limit" name="post_short_desc_limit" type="text" class="form-control noscroll_textarea" value="<?php echo e($additional->post_short_desc_limit); ?>" data-bvalidator="required,digit,min[0]"><small>(<?php echo e(Helper::translation('61e543db0a7d8',$translate,'if you will set "0" full text displaying')); ?>)</small>
                                                
                                                
                                             </div>
                                            
                                          <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation('61e51a5c61c06',$translate,'Author Name')); ?> (<?php echo e(Helper::translation('61e51a3a36990',$translate,'chars length')); ?>) <span class="require">*</span></label><br/>
                                               <input id="author_name_limit" name="author_name_limit" type="text" class="form-control noscroll_textarea" value="<?php echo e($additional->author_name_limit); ?>" data-bvalidator="required,digit,min[0]"><small>(<?php echo e(Helper::translation('61e543db0a7d8',$translate,'if you will set "0" full text displaying')); ?>)</small>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                             ...
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(2938,$translate,'Item Name')); ?> (<?php echo e(Helper::translation('61e51a3a36990',$translate,'chars length')); ?>) <span class="require">*</span></label><br/>
                                               <input id="item_name_limit" name="item_name_limit" type="text" class="form-control noscroll_textarea" value="<?php echo e($additional->item_name_limit); ?>" data-bvalidator="required,digit,min[0]"><small>(<?php echo e(Helper::translation('61e543db0a7d8',$translate,'if you will set "0" full text displaying')); ?>)</small>
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/limitation-settings.blade.php ENDPATH**/ ?>