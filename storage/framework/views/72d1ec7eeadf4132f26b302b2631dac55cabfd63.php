                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <img class="lazy userphoto" width="50" height="50" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($edit['userdata']->user_photo); ?>"  /><?php else: ?> <img class="lazy userphoto" width="50" height="50" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  />  <?php endif; ?>
                                                
                                                <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(3119,$translate,'')); ?><span class="require">*</span></label>
                                                <select name="exclusive_author" class="form-control" required>
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['userdata']->exclusive_author == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(2970,$translate,'')); ?></option>
                                                <option value="0" <?php if($edit['userdata']->exclusive_author == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(2971,$translate,'')); ?></option>
                                                </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(5667,$translate,'')); ?><span class="require">*</span></label>
                                                <select name="user_subscr_payment_status" class="form-control" required>
                                                <option value=""></option>
                                                <option value="pending" <?php if($edit['userdata']->user_subscr_payment_status == 'pending'): ?> selected <?php endif; ?>><?php echo e(Helper::translation(5676,$translate,'')); ?></option>
                                                <option value="completed" <?php if($edit['userdata']->user_subscr_payment_status == 'completed'): ?> selected <?php endif; ?>><?php echo e(Helper::translation(5673,$translate,'')); ?></option>
                                                </select>
                                                </div>
                                                <?php endif; ?> 
                                                
                                                <div class="form-group">
                                                    <label for="earnings" class="control-label mb-1"><?php echo e(Helper::translation(3140,$translate,'Download')); ?> <?php echo e(Helper::translation(6198,$translate,'')); ?> (<?php echo e(Helper::translation(6428,$translate,'Per Day')); ?>) <span class="require">*</span></label>
                                                    <input id="user_subscr_download_item" name="user_subscr_download_item" type="text" class="form-control" value="<?php echo e($edit['userdata']->user_subscr_download_item); ?>"required>
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['userdata']->verified == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(5202,$translate,'')); ?></option>
                                                <option value="0" <?php if($edit['userdata']->verified == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(5205,$translate,'')); ?></option>
                                                </select>
                                                </div>
                                                ...
                                                <input type="hidden" name="become_author" value="<?php echo e($edit['userdata']->become_author); ?>">
                                                <input type="hidden" name="user_subscr_date" value="<?php echo e($edit['userdata']->user_subscr_date); ?>">
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/edit-vendor.blade.php ENDPATH**/ ?>