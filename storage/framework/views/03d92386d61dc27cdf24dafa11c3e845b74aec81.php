...
.btn-custom
{
color:<?php echo e($additional->download_button_text_color); ?>;background-color:<?php echo e($additional->download_button_bg_color); ?>;border-color:<?php echo e($additional->download_button_bg_color); ?>;box-shadow:none;
}
.btn-custom:hover
{
color:<?php echo e($additional->download_button_text_color); ?>;
}
.btn-favorites
{
color:<?php echo e($additional->favorites_button_text_color); ?>;background-color:<?php echo e($additional->favorites_button_bg_color); ?>;border-color:<?php echo e($additional->favorites_button_bg_color); ?>;box-shadow:none;
}
.btn-favorites:hover
{
color:<?php echo e($additional->favorites_button_text_color); ?>;
}
.btn-portfolio
{
color:<?php echo e($additional->portfolio_button_text_color); ?>;background-color:<?php echo e($additional->portfolio_button_bg_color); ?>;border-color:<?php echo e($additional->portfolio_button_bg_color); ?>;box-shadow:none;
}
.btn-portfolio:hover
{
color:<?php echo e($additional->portfolio_button_text_color); ?>;
}
/* extra work */
</style>
<?php if($additional->site_custom_css != ""): ?>
<style type="text/css">
<?php echo e($additional->site_custom_css); ?>

</style>
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/dynamic.blade.php ENDPATH**/ ?>