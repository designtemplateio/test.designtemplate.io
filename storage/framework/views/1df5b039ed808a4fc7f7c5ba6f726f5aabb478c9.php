<div class="page-title-overlap pt-4" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0"><?php echo e(Helper::translation(2990,$translate,'')); ?></h1>
        </div>
      </div>
    </div>
<div class="container mb-5 pb-3">
        ...
        <div class="row">
          ...
          <section class="<?php if(Auth::user()->id == 1): ?> col-lg-12 pl-4 <?php else: ?> col-lg-8 <?php endif; ?> pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              ...
              <img class="lazy rounded-lg" width="200" height="155" src="<?php echo e(Helper::Image_Path($featured->item_preview,'no-image.png')); ?>"  alt="<?php echo e($featured->item_name); ?>">
              <?php else: ?>
              <img class="lazy rounded-lg" width="200" height="155" src="<?php echo e(url('/')); ?>/public/img/no-image.png"  alt="<?php echo e($featured->item_name); ?>">
              <?php endif; ?>
              ...
              <div class="align-items-center text-center py-4">
                  <h3 class="h6 product-title mb-2">Hey No Favourites? Explore from the thousands of Temapltates we provide</h3>
                  <a href="<?php echo e(URL::to('/templates')); ?>"><button class="get_licence m-2 py-1 px-5"> Explore More </button></a>
              </div>
              <?php endif; ?>
            </div>
          </section>
    ...
    </div><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/my-favourite.blade.php ENDPATH**/ ?>