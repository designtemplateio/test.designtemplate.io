<div class="cz-sidebar-static rounded-lg box-shadow-lg px-0 pb-0 mb-5 mb-lg-0">
            <div class="px-4 mb-4">
              <div class="media align-items-center">
                ...
                <img class="lazy rounded-circle" width="102" height="102" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e(Auth::user()->user_photo); ?>"  alt="<?php echo e(Auth::user()->name); ?>">
                <?php else: ?>
                <img class="lazy rounded-circle"  width="102" height="102" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  alt="<?php echo e(Auth::user()->name); ?>">
                <?php endif; ?>
                </div>
                <div class="media-body pl-3">
                  <h3 class="font-size-base mb-0">
                  <?php if($addition_settings->author_name_limit != 0): ?>
				  <?php echo e(mb_substr(Auth::user()->name,0,$addition_settings->author_name_limit,'utf-8')); ?>

			      <?php else: ?>
				  <?php echo e(Auth::user()->name); ?>	  
				  <?php endif; ?><br>	  
			      <?php if($addition_settings->subscription_mode == 1): ?> <?php if(Auth::user()->user_type == 'vendor'): ?> <?php if(Auth::user()->user_document_verified == 1): ?> <span class="badges-success"><i class="dwg-check-circle danger"></i> <?php echo e(Helper::translation(5202,$translate,'')); ?></span> <?php endif; ?> <?php endif; ?> <?php endif; ?></h3><span class="text-accent font-size-sm"><?php echo e(Auth::user()->email); ?></span>
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/user')); ?>/<?php echo e(Auth::user()->username); ?>"><i class="dwg-home opacity-60 mr-2"></i>Portfolio</a></li>
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/profile-settings')); ?>"><i class="dwg-settings opacity-60 mr-2"></i>Profile Settings</a></li>
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/affiliates')); ?>/<?php echo e(Auth::user()->username); ?>"><i class="dwg-money-bag opacity-60 mr-2"></i>Affiliate Program</a></li>
            ...
            <?php else: ?>
              <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/manage-item')); ?>"><i class="dwg-briefcase opacity-60 mr-2"></i>Become Author</a></li>
            <?php endif; ?>
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/deposit')); ?>"><i class="dwg-money-bag opacity-60 mr-2"></i><?php echo e(Helper::translation('61b32a5049abd',$translate,'Deposit')); ?></a></li>
            <?php if(Auth::user()->exclusive_author == 1): ?>
            ...
            <!--<li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/coupon')); ?>"><i class="dwg-gift opacity-60 mr-2"></i><?php echo e(Helper::translation(2919,$translate,'')); ?></a></li>-->
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/affiliates')); ?>/<?php echo e(Auth::user()->username); ?>"><i class="dwg-money-bag opacity-60 mr-2"></i>Affiliate Program</a></li>
            <?php if(Auth::user()->exclusive_author == 0): ?>
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/manage-item')); ?>"><i class="dwg-briefcase opacity-60 mr-2"></i>Become Author</a></li>
            <?php else: ?>
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/manage-item')); ?>"><i class="dwg-briefcase opacity-60 mr-2"></i><?php echo e(Helper::translation(2932,$translate,'')); ?></a></li>
            <?php endif; ?>
           ...
           </div><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/dashboard-menu.blade.php ENDPATH**/ ?>