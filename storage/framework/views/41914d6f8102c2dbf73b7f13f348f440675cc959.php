...
<section class="bg-position-center-top" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0"><?php echo e(Helper::translation(3225,$translate,'')); ?></h1>
        </div>
      </div>
      </div>
    </section>
        ...
        <div class="col-md-6 mx-auto">
          <div class="card border-0 box-shadow">
            ...
            <?php if($allsettings->display_social_login == 1): ?>
              <h1 class="h3 mb-1 text-center"><?php echo e(Helper::translation(3225,$translate,'')); ?></h1>
              <div class="py-3">
              ...
              <form action="<?php echo e(route('login')); ?>" method="POST" id="login_form" class="<?php if($allsettings->display_social_login == 0): ?> py-3 <?php endif; ?>">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                  <div>
                  <span class="text15"><?php echo e(Helper::translation(4875,$translate,'')); ?></span> <a href="<?php echo e(URL::to('/register')); ?>" class="nav-link-inline font-size-sm"><?php echo e(Helper::translation(3187,$translate,'')); ?></a>
...
</html><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>