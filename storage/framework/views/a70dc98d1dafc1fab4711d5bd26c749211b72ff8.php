   ...
   <div class="container-fluid-sm p-2"> 
        <div class="dropdown d-flex justify-content-between align-item-center">
            ...
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"style="color:#000000;"><?php echo e(Helper::translation(4842,$translate,'')); ?></li>
            </ol>
          </nav>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/new-releases.blade.php ENDPATH**/ ?>