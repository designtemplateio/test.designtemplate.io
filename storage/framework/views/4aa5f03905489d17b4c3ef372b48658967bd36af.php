            ...
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Upload Product Page - <?php echo e($type_name->item_type_name); ?></h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                       <div class="card">
                           ...
                           <?php else: ?>
                        <form action="<?php echo e(route('admin.upload-product-page')); ?>" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <input type="text" id="subheading_name" name="subheading_name" class="form-control" data-bvalidator="required,maxlen[100]"> 
                                            </div>
                                            ...
                                            <div class="form-group">
                                               ...
                                               <input type="text" id="para_heading" name="product_heading1" class="form-control" data-bvalidator="required,maxlen[100]"> 
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">Product Paragraph Text<span class="require">*</span></label>
                                                <textarea name="product_para_text" rows="3"  class="form-control" data-bvalidator="required"></textarea>
                                            </div>
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/upload-product-page.blade.php ENDPATH**/ ?>