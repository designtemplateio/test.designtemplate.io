...
<html lang="en">
<head>
<title>Sales Page - <?php echo e($allsettings->site_title); ?></title>
        ...
        <div class="col-lg-7">
              <h1 class="sales-page-heading text-wrap py-4">Create Stunning Motion Graphics with 100K+ Video Elements</h1>
                  <div class="video-wrapper">
                      <video preload="metadata" class="img-fluid salesVideoPreview" id="myVideo" autoplay="" playsinline="" muted="" loop=""> <source src="<?php echo e(url('/')); ?>/public/video/sales-page-video.mp4" type="video/webm"> </video>
                  </div>
...
<section class="text-center py-5">
        <img src="<?php echo e(url('/')); ?>/public/img/Clients_logo.webp" class="img-fluid" alt="Clients_logo">
</section>
  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="my-auto col-md-7 text-center">
            <img src="<?php echo e(url('/')); ?>/public/img/Sales-page-banner1.avif" class="img-fluid" alt="Sales-page-banner">
        </div>
...
<section class="container py-5">
    ...
    <div class="row justify-content-center align-items-center py-5">
            ...
            <div class="my-auto col-lg-6 text-center">
                <img src="<?php echo e(url('/')); ?>/public/img/slideshow-sales-page2.webp" class="img-fluid" alt="slideshow-sales-page">
            </div>
     </div>
</section>
...
<section class="container-fluid text-center justify-content-center py-2" style="background:#FEDB32;">
  <div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="my-auto col-md-7 text-center">
            <img src="<?php echo e(url('/')); ?>/public/img/Sales-page-banner2.webp" class="img-fluid" alt="Sales-page-banner">
        </div>
        <div class="col-md-5 col-lg-5">
            <div class="mx-auto">
...
<section class="container py-5">
     <h1 class="heading_unlimited text-center p-2">Recommended By Design Template</h1>
      <div class="row justify-content-center align-items-center">
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Logo Preview.jpg">
	           <source src="<?php echo e(url('/')); ?>/public/video/Logo Preview.mp4" type="video/mp4">
              </video>
             </div>
          </div>
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Sport Preview.webp">
	           <source src="<?php echo e(url('/')); ?>/public/video/Sport Preview.mp4" type="video/mp4">
              </video>
             </div>
          </div>
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Logo DT Preview.jpg">
	           <source src="<?php echo e(url('/')); ?>/public/video/Logo DT Preview.mp4" type="video/mp4">
              </video>
             </div>
          </div>
     </div>
     <div class="row justify-content-center align-items-center">
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Urban Intro folder Thumbnail.jpg">
	           <source src="<?php echo e(url('/')); ?>/public/video/Urban Intro folder Preview.mp4" type="video/mp4">
              </video>
             </div>
          </div> 
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Funky Colorful Intro folder Thumbnail.jpg">
	           <source src="<?php echo e(url('/')); ?>/public/video/Funky Colorful Intro folder Preview.mp4" type="video/mp4">
              </video>
             </div>
          </div>
          <div class="col-md-4 col-lg-4 py-2">
             <div class="video-wrapper">
              <video class="img-fluid salesVideoPreview videoPreview" muted loop poster="<?php echo e(url('/')); ?>/public/img/Paper Style Slideshow Thumbnail.jpg">
	           <source src="<?php echo e(url('/')); ?>/public/video/Paper Style Slideshow.mp4" type="video/mp4">
              </video>
             </div>
          </div>
     </div>
...
<section class="container-fluid text-center justify-content-center py-5" style="background:#f7f8fd;">
     <img src="<?php echo e(url('/')); ?>/public/img/Sale-Now-On-Banner.webp" class="img-fluid pb-5" width="1920" style="border-radius:5px;" alt="Sale-Now-On-Banner"><br>
...
<section class="container py-5 text-center">
    <div class="row">
          <div class="col-md-4 col-lg-4">
              	<img src="<?php echo e(url('/')); ?>/public/img/Review1.webp" alt="review1">
          </div>
          <div class="col-md-4 col-lg-4">
              	<img src="<?php echo e(url('/')); ?>/public/img/review2.webp" alt="review2">
          </div>
          <div class="col-md-4 col-lg-4">
              	<img src="<?php echo e(url('/')); ?>/public/img/Review7.webp" alt="review7">
          </div>
    </div>
    <div class="row">
          <div class="col-md-4 col-lg-4">
              	<img src="<?php echo e(url('/')); ?>/public/img/Review4.webp" alt="review4">
          </div>
          <div class="col-md-4 col-lg-4">
                <img src="<?php echo e(url('/')); ?>/public/img/Review3.webp" alt="review3">
          </div>
          <div class="col-md-4 col-lg-4">
              	<img src="<?php echo e(url('/')); ?>/public/img/Review6.webp" alt="review6">
          </div>
    </div>
</section>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/sales-page.blade.php ENDPATH**/ ?>