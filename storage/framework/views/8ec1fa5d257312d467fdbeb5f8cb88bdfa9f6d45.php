...
<title><?php  $currentUrl = url()->current(); ?>
            <?php if($currentUrl == 'https://designtemplate.io/templates'): ?>
             Explore Unique Design Templates - Design Template
            <?php endif; ?> 
            <?php for($i = 3; $i <= count(Request::segments()); $i++): ?>
            Unique <?php echo e(str_replace('-',' ',(Request::segment($i)))); ?> Design Templates - Design Template 
            <?php endfor; ?> 
</title>
...
<section class="container-fluid px-5 pt-2" style="background:linear-gradient(180deg, rgba(23, 23, 23, 0) 0%, #eaeaef 100%), linear-gradient(270deg, #ef8cbd 0%, #b091ee 70%, #c9ddf8 90%);">
   <div class="container-fluid-sm p-2"> 
    ...
    <div class="container text-center align-items-center justify-content-center">
            ...
            <?php endif; ?>
            <?php for($i = 3; $i <= count(Request::segments()); $i++): ?>
              <?php if((Request::segment($i))=='after-effects'): ?>
              ...
              <?php elseif((Request::segment($i))=='premiere-pro'): ?>
              ...
              <?php elseif((Request::segment($i))=='motion-graphics'): ?>
              ...
              <?php elseif((Request::segment($i))=='graphic-design'): ?>
              ...
              <!--Subcategory-->
              <?php elseif((Request::segment($i))=='Elements'): ?>
              <h1 class="heading cat-title text-center text-wrap px-2">Elevate videos with After Effects elements & overlays!</h1>
              ...
              <?php elseif((Request::segment($i))=='Logo-Animation'): ?>
              ...
              <?php elseif((Request::segment($i))=='Titles'): ?>
              ...
              <?php elseif((Request::segment($i))=='Slideshow'): ?>
              ...
              <?php elseif((Request::segment($i))=='Opener-&-Intro'): ?>
              ...
              <?php elseif((Request::segment($i))=='social-media'): ?>
              ...
              <?php elseif((Request::segment($i))=='invitation-and-wishes'): ?>
              ...
              <?php elseif((Request::segment($i))=='elements-and-overlays'): ?>
              ...
              <?php elseif((Request::segment($i))=='logo-reveal'): ?>
              ...
              <?php elseif((Request::segment($i))=='text-and-title'): ?>
              ...
              <?php elseif((Request::segment($i))=='video-display-slideshow'): ?>
              ...
              <?php elseif((Request::segment($i))=='invitation-and-greeting'): ?>
              ...
              <?php elseif((Request::segment($i))=='overlay-elements'): ?>
              ...
              <?php elseif((Request::segment($i))=='Transitions'): ?>
              ...
              <?php elseif((Request::segment($i))=='illustrations'): ?>
  ...
  <?php endif; ?>
       <?php if($method == 'post'): ?>
        ...
        <div class="container d-flex flex-wrap text-left py-5">
         <h2 class="heading_unlimited new mb-0 pb-3">Similar Search for "<?php echo e($product_item); ?>" Templates</h2>
      </div>
            <?php $no = 1; ?>
...
<section class="container-fluid">
    ...
    <?php endif; ?>
     <?php for($i = 3; $i <= count(Request::segments()); $i++): ?>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='premiere-pro'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='motion-graphics'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='graphic-design'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <!--Subcategory-->
        <?php if((Request::segment($i))=='Elements'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='Logo-Animation'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='Titles'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='Slideshow'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='Opener-&-Intro'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='social-media'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='invitation-and-wishes'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='elements-and-overlays'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='logo-reveal'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='text-and-title'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='video-display-slideshow'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='invitation-and-greeting'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='overlay-elements'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='Transitions'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
        ...
        <?php endif; ?>
        <?php if((Request::segment($i))=='illustrations'): ?>
        <div class="questions-container">
            <div class="question">
                <button>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/templates.blade.php ENDPATH**/ ?>