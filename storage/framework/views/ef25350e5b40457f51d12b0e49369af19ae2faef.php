                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" name="user_type" value="admin">
                                               <div class="form-group">
                                                ...
                                                <img class="lazy userphoto" width="50" height="50" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($edit['userdata']->user_photo); ?>"  /><?php else: ?> <img class="lazy userphoto" width="50" height="50" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  />  <?php endif; ?></div>
                                      </div>
                                </div>
                               </div>
                            </div>
...
</html><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/edit-administrator.blade.php ENDPATH**/ ?>