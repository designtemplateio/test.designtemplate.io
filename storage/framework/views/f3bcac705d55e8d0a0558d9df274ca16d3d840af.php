...
<?php if($page['page']->page_title != "About Us"): ?>
<section class="bg-position-center-top" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');">
      <div class="py-4">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0"><?php echo e($page['page']->page_title); ?></h1>
        </div>
      </div>
      </div>
    </section>
<?php if($page['page']->page_title != "Faq"): ?>
...
<section class="our-webcoderskull pt-3">
  <div class="container">
    ...
    <div class="widget my-4 text-md-nowrap text-center text-md-center">
            ...
            <a class="social-btn sb-facebook mr-2 mb-2" href="<?php echo e($allsettings->facebook_url); ?>" target="_blank"><i class="dwg-facebook"></i></a>
            <?php endif; ?>
            <?php if($allsettings->twitter_url != ''): ?>
            <a class="social-btn sb-twitter mr-2 mb-2" href="<?php echo e($allsettings->twitter_url); ?>" target="_blank"><i class="dwg-twitter"></i></a>
            <?php endif; ?>
            <?php if($allsettings->pinterest_url != ''): ?>
            <a class="social-btn sb-pinterest mr-2 mb-2" href="<?php echo e($allsettings->pinterest_url); ?>" target="_blank"><i class="dwg-pinterest"></i></a>
            <?php endif; ?>
            <?php if($allsettings->gplus_url != ''): ?>
            <a class="social-btn sb-dribbble mr-2 mb-2" href="<?php echo e($allsettings->gplus_url); ?>" target="_blank"><i class="dwg-google"></i></a>
            <?php endif; ?>
            <?php if($allsettings->linkedin_url != ''): ?>
            <a class="social-btn sb-behance mr-2 mb-2" href="<?php echo e($allsettings->linkedin_url); ?>" target="_blank"><i class="dwg-linkedin"></i></a>
            <?php endif; ?>
            <?php if($allsettings->instagram_url != ''): ?>
            <a class="social-btn sb-behance mr-2 mb-2" href="<?php echo e($allsettings->instagram_url); ?>" target="_blank"><i class="dwg-instagram"></i></a>
            <?php endif; ?>
            </div>
    </div>
</section>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/page.blade.php ENDPATH**/ ?>