...
<html lang="en">
<head>
<title><?php echo e($allsettings->site_title); ?> - <?php echo e(Helper::translation(3207,$translate,'')); ?></title>
        ...
        <div class="product-review pb-4 mb-4 border-bottom prod-item" data-aos="fade-up" data-aos-delay="200">
                <div class="d-flex mb-3">
                  <div class="media media-ie-fix align-items-center mr-4 pr-2">
                                    ...
                                    <img class="lazy rounded-circle" width="50" height="50" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($review->user_photo); ?>"  alt="<?php echo e($review->username); ?>">
                                    <?php else: ?>
                                    <img class="lazy rounded-circle" width="50" height="50" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  alt="<?php echo e($review->username); ?>">
                                    <?php endif; ?>
                                    </a>
                      ...
                      <a href="<?php echo e(url('/item')); ?>/<?php echo e($review->item_slug); ?>" class="theme-color"><?php echo e($review->item_name); ?></a><br/>
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/user-reviews.blade.php ENDPATH**/ ?>