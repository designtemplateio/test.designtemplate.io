...
<html lang="en">
<head>
<title>Create Thrilling Videos with Ease - <?php echo e($allsettings->site_title); ?></title>
...
<section class="container-fluid bg-position-center-top-banner bg-hero-section-image">
     <div class="row h-100 align-items-center p-3 mt-0">
        <div class="col-lg-6 my-auto ">
              <h1 class="heading text-left text-wrap px-2"><?php echo e($allsettings->site_banner_heading); ?></h1>
              ...
              <div class="text-left d-none d-lg-block p-3">
                ...
                <a href="<?php echo e(URL::to('/')); ?>/free-items"><button class="get_licence py-2 px-5" style="width:300px;">Download Free Templates</button></a>
             </div>
         </div>
        <div class="col-lg-6 text-center my-auto">
            <div class="video-wrapper ">
              <video preload="metadata" class="img-fluid" autoplay="" playsinline="" muted="" loop="">
	           <source src="<?php echo e(url('/')); ?>/public/video/Home-slider-video1.webm" type="video/webm">
              </video>
             </div>
            <div class="d-lg-none">
...
<section class="product-banner pb-5 pt-3 tab-pane fade in active" id="allTemplates">
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Explore motion graphics design Templates for Stuning Video</p>
        <?php if(count($all['items']) != 0): ?>
        <div class="d-flex flex-wrap justify-content-end align-items-center pt-2">
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $all['items']->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
                                  ...
                                  <a  href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>">
                                      ...
                                      <?php else: ?>
                                        <?php if($featured->item_preview!=''): ?>
                                             <img class="img-fluid card-img-top" loading="lazy" width="60%" height="60%" src="<?php echo e(Helper::Image_Path($featured->item_preview,'no-image.png')); ?>"  alt="<?php echo e($featured->item_name); ?>">
                                        <?php else: ?>
                                            <img class="img-fluid card-img-top" loading="lazy" width="60%" height="60%" src="/img/no-image.png"  alt="<?php echo e($featured->item_name); ?>">
                                        <?php endif; ?>
                                      <?php endif; ?>
                                  </a>
                            </figure>
                            ...
                            <figure>
                                <span class="free"><?php echo e(Helper::translation(2992,$translate,'')); ?></span> 
                                  <a  href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>">
                                      <?php if($featured->preview_video!=''): ?>
                                        <video class="videoPreview" muted loop poster="<?php echo e(Helper::Image_Path($featured->item_preview,'lazy_load_thumbnail.webp')); ?>">
                                                <source src="/storage/app/videos/<?php echo e($featured->preview_video); ?>" type="video/mp4">
                                        </video>
                                      <?php else: ?>
                                        <?php if($featured->item_preview!=''): ?>
                                            <img class="img-fluid card-img-top" loading="lazy" width="60%" height="60%" src="<?php echo e(Helper::Image_Path($featured->item_preview,'no-image.png')); ?>"  alt="<?php echo e($featured->item_name); ?>">
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/templates')); ?>"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Get Started with Free After Effects Templates Today</p>
        <?php if(count($aetemplate['items']) != 0): ?>
        <div class="d-flex flex-wrap justify-content-end align-items-center pt-2">
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $aetemplate['items']->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/templates')); ?>/category/after-effects"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Free Premiere Pro Templates: Where Creativity Takes Flight in a Click!</p>
       ...
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $flash['items']->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/templates')); ?>/category/premiere-pro"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Illustrate Your Imagination: Free Illustrations that Bring Your Ideas to Life!</p>
        <?php if(count($illustration['items']) != 0): ?>
        <div class="d-flex flex-wrap justify-content-end align-items-center pt-2">
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $illustration['items']->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/templates')); ?>/category/graphic-design"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Motion Graphics Wonderland for Stunning Videos by design template!</p>
       ...
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $popular['items']->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/templates')); ?>/category/motion-graphics"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
...
<section class="container-fluid bg-position-center-top-banner bg-hero-section-image pb-0 justify-content-center" style="min-height:16rem;">
    ...
    <div class="col-6 justify-content-center">
        <form action="<?php echo e(route('shop')); ?>" id="search_form2" method="post" enctype="multipart/form-data">
            ...
            <!--      <input class="form-control" type="text" name="product_item" placeholder="<?php echo e(Helper::translation(4857,$translate,'')); ?> All Assets">-->
            ...
            <!--    </div>-->
                <div class="input-group mb-4 mt-2 search-input">
                  <input class="form-control border-0" type="text" name="product_item" placeholder="<?php echo e(Helper::translation(4857,$translate,'')); ?> All Assets">
                  <div class="input-group-append-overlay"><span class="input-group-text"><i class="dwg-search"></i></span></div>
                </div>
        </form>
    </div><br>
    ...
    <div class="col-6 text-center">
                 ...
                 <?php $__currentLoopData = $firstSixTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tags): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <span class="text-right"><a href="<?php echo e(url('/tag')); ?>/item/<?php echo e(strtolower(str_replace(' ','-',$tags))); ?>" class="btn-tag mr-2 my-1 py-1" style="border-radius: 6.907px;border: 1.151px solid #7D879C;background: #F7F8FD;"><?php echo e($tags); ?></a></span>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    </div>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Explore motion graphics design Templates for Stuning Video</p>
       ...
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $all['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Get Started with Free After Effects Templates Today</p>
       ...
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $aetemplate['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
      <p class="sm-heading text-center pb-2 mb-0 px-10 d-none d-lg-block">Illustrate Your Imagination: Free Illustrations that Bring Your Ideas to Life!</p>
       ...
       <div class="row equal-height justify-content-center">
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $illustration['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
  ...
  <div class="container d-flex flex-wrap justify-content-center align-items-center">
    ...
    <div class="d-flex flex-wrap justify-content-end align-items-center pt-2">
       <div class="row equal-height justify-content-center">
        ...
        <!-- Product-->
        <?php $no = 1; ?>
        <?php $__currentLoopData = $free['items']->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        $price = Helper::price_info($featured->item_flash,$featured->regular_price);
        $count_rating = Helper::count_rating($featured->ratings);
        ?>
              ...
              <figure>
                <span class="free"><?php echo e(Helper::translation(2992,$translate,'')); ?></span> 
                    <a href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>">
                        ...
                        <?php else: ?>   
                            <?php if($featured->item_preview!=''): ?>
                                <img class="lazy_load img-fluid card-img-top" loading="lazy" width="90%" height="90%" src="<?php echo e(url('/')); ?>/public/img/lazy_load_thumbnail.webp" data-src="<?php echo e(Helper::Image_Path($featured->item_preview,'lazy_load_thumbnail.webp')); ?>"  data-srcset="<?php echo e(Helper::Image_Path($featured->item_preview,'lazy_load_thumbnail.webp')); ?>" alt="<?php echo e($featured->item_name); ?>">
                            <?php else: ?>
                                <img class="img-fluid card-img-top" loading="lazy" width="60%" height="60%" src="<?php echo e(url('/')); ?>/public/img/no-image.png"  alt="<?php echo e($featured->item_name); ?>">
                            <?php endif; ?>
                        <?php endif; ?>
    ...
    <?php endif; ?>
      <div class="container d-flex flex-wrap justify-content-center align-items-center">
        <div class="p-2 text-center">
          <a href="<?php echo e(URL::to('/')); ?>/free-items"><button class="get_licence py-2 px-5" >Explore More</button></a>
        </div>
      </div>
      </div>
  </section>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row hidden-md-up">
        <div class="col-md-4">
          <a href="<?php echo e(URL::to('/')); ?>/tag/item/festival"> <div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Festival.webp" alt="Festival">
        ...
        <div class="col-md-4">
         <a href="<?php echo e(URL::to('/')); ?>/tag/item/food"> <div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Food.webp" alt="Food">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
        ...
        <div class="col-md-4">
          <a href="<?php echo e(URL::to('/')); ?>/tag/item/social-media"><div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Social_Media.webp" alt="Social Media">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
      ...
      <div class="row">
        <div class="col-md-4">
         <a href="<?php echo e(URL::to('/')); ?>/tag/item/fashion"> <div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Fashion.webp" alt="Fashion">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
        ...
        <div class="col-md-4">
          <a href="<?php echo e(URL::to('/')); ?>/tag/item/real-estate"><div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Real_Estate.webp" alt="Real Estate">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
       ...
       <div class="row">
        <div class="col-md-4">
          <a href="<?php echo e(URL::to('/')); ?>/tag/item/business"><div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Business.webp" alt="Business">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
        ...
        <div class="col-md-4">
         <a href="<?php echo e(URL::to('/')); ?>/tag/item/education"> <div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Education.webp" alt="Education">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
        ...
        <div class="col-md-4">
          <a href="<?php echo e(URL::to('/')); ?>/tag/item/sports"><div class="card">
            <img class="card-img" src="<?php echo e(URL::to('/')); ?>/public/img/Sports.webp" alt="Sports">
        <div class="card-img-overlay text-white d-flex flex-column justify-content-center pt-5 mt-5 pb-n5 mb-n5">
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/index.blade.php ENDPATH**/ ?>