                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-user"></i><a href="<?php echo e(url('/admin/subscriber')); ?>">Subscriber</a></li>
                            <li><i class="fa fa-user"></i><a href="<?php echo e(url('/admin/author')); ?>">Author</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>                   
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/item-features')); ?>"><?php echo e(Helper::translation(6267,$translate,'')); ?></a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/item-tags')); ?>">Item Tags</a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/coupons')); ?>"><?php echo e(Helper::translation('614ee2c3c306c',$translate,'Coupons')); ?></a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/suggestions')); ?>">Suggestions</a></li>
                    ...
                    <?php if(in_array('items',$avilable)): ?> 
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-file-text-o"></i>Product Page</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/product-page')); ?>">Product Pages</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/product-page-category')); ?>">Category</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/product-page-sub-category')); ?>">Subcategory</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-money"></i><?php echo e(Helper::translation('61b32a5049abd',$translate,'Deposit')); ?></a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/deposit')); ?>"><?php echo e(Helper::translation('631f00343d460',$translate,'Price Details')); ?></a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/deposit-details')); ?>"><?php echo e(Helper::translation('631f01f335a4e',$translate,'Deposit Details')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <li>
                        <a href="<?php echo e(url('/admin/clear-cache')); ?>" onClick="return confirm('<?php echo e(Helper::translation(6419,$translate,'Are you sure you want to clear cache')); ?>?');"> <i class="menu-icon fa fa-trash"></i><?php echo e(Helper::translation(6414,$translate,'Clear Cache')); ?> </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array('upgrade',$avilable)): ?>
                    <li>
                        <a href="<?php echo e(url('/admin/upgrade')); ?>"> <i class="menu-icon fa fa-refresh"></i><?php echo e(Helper::translation(6132,$translate,'Upgrade')); ?> </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array('backups',$avilable)): ?>
                    <li>
                        <a href="<?php echo e(url('/admin/backup')); ?>"> <i class="menu-icon fa fa-hdd-o"></i><?php echo e(Helper::translation('6245a88b2aea5',$translate,'Backups')); ?> </a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    </aside><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/navigation.blade.php ENDPATH**/ ?>