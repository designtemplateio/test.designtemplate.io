            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(2865,$translate,'Add Coupon')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                   ...
                   <div class="col-md-12">
                     <div class="card">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                        <form action="<?php echo e(route('admin.add-coupon')); ?>" method="post" id="checkout_form" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="coupon_status" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="1"><?php echo e(Helper::translation(2874,$translate,'Active')); ?></option>
                                                 <option value="0"><?php echo e(Helper::translation(2875,$translate,'InActive')); ?></option>
                                                 </select>
                                            </div>
                                     </div>
                                </div>
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <select name="discount_type" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="percentage"><?php echo e(Helper::translation(2871,$translate,'Percentage')); ?></option>
                                                 <option value="fixed"><?php echo e(Helper::translation(2872,$translate,'Fixed')); ?></option>
                                                 </select>
                                            </div>
                                    <div class="form-group">
...
</html><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/add-coupon.blade.php ENDPATH**/ ?>