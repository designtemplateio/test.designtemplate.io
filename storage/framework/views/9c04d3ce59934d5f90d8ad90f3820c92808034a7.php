                 ...
                 <?php if($demo_mode == 'on'): ?>
                                 ...
                                 <div class="col-md-6">
                                   ...
                                   <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(6425,$translate,'Upload')); ?> <?php echo e(Helper::translation(6198,$translate,'')); ?> <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3140,$translate,'Download')); ?> <?php echo e(Helper::translation(6198,$translate,'')); ?> (<?php echo e(Helper::translation(6428,$translate,'Per Day')); ?>) - (<?php echo e(Helper::translation(4830,$translate,'Customer')); ?>/<?php echo e(Helper::translation(3142,$translate,'Vendor')); ?>)<span class="require">*</span></label>
                                                <input id="subscr_download_items" name="subscr_download_items" type="text" class="form-control" data-bvalidator="required,digit,min[1]" value="<?php echo e($additional->subscr_download_items); ?>">
                                            </div>
                                      </div>
                  ...
                  <div class="card">
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                 ...
                                 <?php echo $__env->make('admin.demo-mode', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                 <?php else: ?>
                                 <form action="<?php echo e(route('admin.itemdetails')); ?>" method="post" id="checkout_form" enctype="multipart/form-data">
                                 <?php echo e(csrf_field()); ?>
                                 ...
                                 <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                                ...
                                                <input id="download_button_before_text" name="download_button_before_text" type="text" class="form-control" value="<?php echo e($additional->download_button_before_text); ?>" data-bvalidator="required">
                                            </div> 
                                            
                                            
                                  <div class="form-group">
                                                <label for="name" class="control-label mb-1">Download Button Text (After subscribe user) </label>
                                                <input id="download_button_after_text" name="download_button_after_text" type="text" class="form-control" value="<?php echo e($additional->download_button_after_text); ?>" data-bvalidator="required">
                                            </div> 
                                            
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Favorites Button Text Color</label>
                                                <input id="favorites_button_text_color" name="favorites_button_text_color" type="text" class="form-control" value="<?php echo e($additional->favorites_button_text_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Favorites Button Bg Color</label>
                                                <input id="favorites_button_bg_color" name="favorites_button_bg_color" type="text" class="form-control" value="<?php echo e($additional->favorites_button_bg_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
                                      ...
                                      <div class="col-md-6">      
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input id="download_button_text_color" name="download_button_text_color" type="text" class="form-control" value="<?php echo e($additional->download_button_text_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Download Button Bg Color</label>
                                                <input id="download_button_bg_color" name="download_button_bg_color" type="text" class="form-control" value="<?php echo e($additional->download_button_bg_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="portfolio_button_text_color" name="portfolio_button_text_color" type="text" class="form-control" value="<?php echo e($additional->portfolio_button_text_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Portfolio Button Bg Color</label>
                                                <input id="portfolio_button_bg_color" name="portfolio_button_bg_color" type="text" class="form-control" value="<?php echo e($additional->portfolio_button_bg_color); ?>" data-bvalidator="required">
                                                <small>(<?php echo e(Helper::translation(5172,$translate,'')); ?> : #666000 )</small>
                                            </div>
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/subscription.blade.php ENDPATH**/ ?>