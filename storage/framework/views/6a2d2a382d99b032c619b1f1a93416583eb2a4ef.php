            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(4965,$translate,'')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(2937,$translate,'')); ?> <span class="require">*</span></label>
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(4968,$translate,'')); ?> <span class="require">*</span></label>
                                                 <input id="attr_label" name="attr_label" type="text" class="form-control" required>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(4971,$translate,'')); ?></label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(4974,$translate,'')); ?> <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(4977,$translate,'')); ?> <span class="require">*</span></label>
                                                <textarea name="attr_field_value" id="attr_field_value" rows="3" class="form-control noscroll_textarea" required></textarea>
                                                (<?php echo e(Helper::translation(4980,$translate,'')); ?>)
                                            </div>
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/add-attribute.blade.php ENDPATH**/ ?>