...
?>
<div class="col-lg-4 col-md-6 col-sm-6 px-2 mb-grid-gutter prod-item">
          <!-- Product-->
            <div class="equal-col">
             <div class="hover_img">
          <div class="card product-card-alt" style="width:100%;height:100%;background:#fff;">
              <?php
...
<?php $no++; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>        <?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/user-data.blade.php ENDPATH**/ ?>