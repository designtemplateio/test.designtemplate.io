            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(5250,$translate,'')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.edit-post')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <?php if($edit['post']->post_image != ''): ?>
                                                <img class="lazy" width="50" height="50" src="<?php echo e(url('/')); ?>/public/storage/post/<?php echo e($edit['post']->post_image); ?>"  />
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['post']->post_status == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2874,$translate,'')); ?></option>
                                                <option value="0" <?php if($edit['post']->post_status == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(2875,$translate,'')); ?></option>
                                                </select>
                                                
                                            </div> 
                                            
                                                                                       
                                            <input type="hidden" name="post_date" value="<?php echo e($edit['post']->post_date); ?>">  
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['post']->post_allow_seo == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(2970,$translate,'')); ?></option>
                                                <option value="0" <?php if($edit['post']->post_allow_seo == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(2971,$translate,'')); ?></option>
                                                </select>
                                             </div>
                                            
                                          <div id="ifseo" <?php if($edit['post']->post_allow_seo == 1): ?> class="form-group force-block" <?php else: ?> class="form-group force-none" <?php endif; ?>>
                                     <div class="form-group">
                                           <label for="site_keywords" class="control-label mb-1"><?php echo e(Helper::translation(6387,$translate,'')); ?> (<?php echo e(Helper::translation(6390,$translate,'')); ?>) <span class="require">*</span></label>
                                            <textarea name="post_seo_keyword" id="post_seo_keyword" rows="4" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]"><?php echo e($edit['post']->post_seo_keyword); ?></textarea>
                                       </div> 
                                       <div class="form-group">
                                           <label for="site_desc" class="control-label mb-1"><?php echo e(Helper::translation(6393,$translate,'')); ?> (<?php echo e(Helper::translation(6390,$translate,'')); ?>) <span class="require">*</span></label>
                                              <textarea name="post_seo_desc" id="post_seo_desc" rows="4" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]"><?php echo e($edit['post']->post_seo_desc); ?></textarea>
                                            </div>
                                          </div>
...
<?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/admin/edit-post.blade.php ENDPATH**/ ?>