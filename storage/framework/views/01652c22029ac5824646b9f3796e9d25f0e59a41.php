<div class="page-title-overlap pt-4" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0"><?php echo e(Helper::translation(3211,$translate,'')); ?></h1>
        </div>
      </div>
    </div>
<div class="container mb-5 pb-3">
                    ...
                    <div class="options">
                                <?php $no = 1; ?>
                                            ...
                                            <div class="custom-radio">
                                                <input type="radio" id="withdrawal-<?php echo e($withdraw); ?>" name="withdrawal" value="<?php echo e($withdraw); ?>" data-bvalidator="required">
                                           ...
                                           <div class="row form-group" id="ifstripe">
                                            ...
                                            <div class="row form-group" id="ifpayfast">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone"><?php echo e(Helper::translation('6218d15ed6569',$translate,'PayFast Email ID')); ?></label>
                                            ...
                                            <div class="row form-group" id="ifpaytm">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone"><?php echo e(Helper::translation('622f1e7b29f63',$translate,'Paytm Number')); ?></label>
                                                        <input type="text" id="paytm_no" name="paytm_no" class="form-control" data-bvalidator="required">
                                                </div>
                                            </div>
                                            <div class="row form-group" id="ifupi">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone"><?php echo e(Helper::translation('622f214148f4c',$translate,'UPI ID')); ?></label>
                                                        <input type="text" id="upi_id" name="upi_id" class="form-control" data-bvalidator="required">
                                                </div>
                                            </div>
                                            <div class="row form-group" id="ifskrill">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="phone"><?php echo e(Helper::translation('622f1e9c16694',$translate,'Skrill Email ID')); ?></label>
                                            ...
                                            <div class="row form-group" id="iflocalbank">
                                                      <div class="col-md-12 mb-3 mb-md-0">
                                                        ...
                                                        <?php echo e(Helper::translation(5781,$translate,'')); ?> : <?php echo e(Helper::translation('61e677dfca2dd',$translate,'Test Bank')); ?><br/>
                                                        <?php echo e(Helper::translation(5784,$translate,'')); ?> : <?php echo e(Helper::translation('61e677e7660b0',$translate,'Test Branch')); ?><br/>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($withdrawal->payfast_email != ""): ?><?php echo e($withdrawal->payfast_email); ?><?php endif; ?>
                                            <?php if($withdrawal->skrill_email != ""): ?><?php echo e($withdrawal->skrill_email); ?><?php endif; ?>
                                            <?php if($withdrawal->upi_id != ""): ?><?php echo e($withdrawal->upi_id); ?><?php endif; ?>
                                            <?php if($withdrawal->paytm_no != ""): ?><?php echo e($withdrawal->paytm_no); ?><?php endif; ?>
    ...
    </div><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/my-withdrawal.blade.php ENDPATH**/ ?>