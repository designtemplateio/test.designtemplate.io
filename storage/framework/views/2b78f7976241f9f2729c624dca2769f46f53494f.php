        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              <li class="breadcrumb-item"><a class="text-nowrap text-light" href="<?php echo e(URL::to('/')); ?>"><i class="dwg-home"></i><?php echo e(Helper::translation(2862,$translate,'')); ?></a></li>
              <li class="breadcrumb-item text-nowrap active text-light" aria-current="page"><?php echo e(Helper::translation(3233,$translate,'')); ?></li>
            </ol>
          </nav>
        </div>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input id="username" type="text" name="username" class="form-control" placeholder="<?php echo e(Helper::translation(3239,$translate,'')); ?>" data-bvalidator="required" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
...
<?php endif; ?><?php /**PATH /home/u728587553/domains/designtemplate.io/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>